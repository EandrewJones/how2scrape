...
*Note: I like the %<>% pipe operator from* `magrittr` *to modify data frames in place and make my code cleaner. However, this can be dangerous/annoying if you make a mistake and overwrite your object.*
...
2. [lubridate](images/Times and Dates_lubridate.pdf)
